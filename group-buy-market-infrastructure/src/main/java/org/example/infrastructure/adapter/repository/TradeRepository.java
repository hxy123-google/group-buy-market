...
public class TradeRepository implements ITradeRepository {
    ...
    public MarketPayOrderEntity queryMarketPayOrderEntityByOutTradeNo(String userId, String outTradeNo){
        ...
        GroupBuyOrderList groupBuyOrderListRes=groupBuyOrderListDao.queryGroupBuyOrderRecordByOutTradeNo(groupBuyOrderListReq);//查锁定订单
        if(null==groupBuyOrderListRes) return null;
        return MarketPayOrderEntity.builder().orderId(groupBuyOrderListRes.getOrderId())
